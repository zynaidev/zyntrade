...
import { getTrades } from '../lib/supabaseClient'
  ...
  return (
    <main className="w-full max-w-7xl mx-auto py-12 px-8 lg:px-10 space-y-16">
      ...
      <div>
        ...
        >
          {[
            { label: 'Nettó PnL', value: `$${stats.netPnl.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, icon: DollarSign, color: stats.netPnl >= 0 ? '#22c55e' : '#ef4444', bg: stats.netPnl >= 0 ? 'rgba(34,197,94,0.1)' : 'rgba(239,68,68,0.1)' },
